...
if __name__ == '__main__':
    ...
    # x, y = util.loadImgDataForCNN(img_rows=224, img_cols=224, label_exclude=["cycling", "running"])
    ...
    print("Data loaded. Train-test split starts... Test size: 0.2")
    ...
    #
    # input_tensor = Input(tensor=dataset, shape=(224,224,3))

    print("Starting ResNet50 function...")
    model = ResNet50(include_top=True, weights=None, pooling='max', classes=3)
    model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=["accuracy"])
    hist = model.fit(X_train, y_train, batch_size=16, epochs=50, verbose=1, validation_split=0.2)
    ...
    util.saveCNNModelAsJson(model, "resnet50 (50 ep 16 bs).json", "resnet50 (50 ep 16 bs).h5")
    ...
    # IMAGE_PATH = "D:/kader/kad_ER_/METU/CENG (Grad)/Master\'s Thesis/NTCIR13-lifelog2-phase2-images/Images/u2/2016/2016-10-03/20161003_071527_000.jpg"
    ...
    #
    # x = util.loadSingleImage('u2/2016/2016-10-03/20161003_071527_000.jpg', 224, 224, 3)
